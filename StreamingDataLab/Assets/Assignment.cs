...
// Get the ability to save a line of text working
// !!! Figure out how we want to format the data we want to save
//
// write character values to the .txt
// do something to support the party size... save it first
